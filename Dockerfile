...
# Next.js inlines NEXT_PUBLIC_* at compile time. Docker only exposes build-args to
# `RUN` after ARG + ENV. Railway passes service variables as `docker build` args
# when they are enabled for the build — see docs/deployment.md.
