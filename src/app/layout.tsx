...
export const metadata: Metadata = {
  ...
  description: "Automated Before & After marketing video dashboard for multiple brands.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${outfit.className}`} suppressHydrationWarning>
      ...
      <body
        className={`${outfit.variable} ${outfit.className} font-sans min-h-screen bg-slate-50 text-slate-900 antialiased dark:bg-slate-950 dark:text-slate-100`}
      >
