...
export const TEMPLATE_MODES = [
  {
    ...
    description: "Two photos — ideal for beauty, hair, and transformation results.",
  },
  {
    id: "single-image" as const,
    label: "Single image",
    shortLabel: "Single image",
    description: "One hero photo — for promos, products, or non–before/after services.",
  },
  {
    id: "carousel" as const,
    label: "Carousel",
    shortLabel: "Carousel",
    description: "Multiple images cycle in the video — each with its own title.",
  },
] as const;
...
export function templateModeToCompositionId(mode: TemplateModeId): RemotionCompositionId {
